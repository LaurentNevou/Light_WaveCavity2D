...
f0_min  = c/20e-6;    %% filter the solutions where the frequency is superior than (Hz), f=c/lambda
f0_max  = c/0.8e-6;   %% filter the solutions where the frequency is inferior than (Hz), f=c/lambda
nmodes=18;            %% number of solutions asked 
...
Nx=41;                  %% Meshing point in x-direction
Ny=51;                  %% Meshing point in y-direction
...
Rx_min=1e-6; Ry_min=1e-6;
Rx_max=1.5e-6; Ry_max=1.5e-6;
[n,eps]=epsRing_f(x,y,Rx_min,Ry_min,Rx_max,Ry_max,n1,n2,AbsorbingBoundaryCondition);
